...
public class ApplicationBuilder : IDesignTimeApplicationFactory {
    public static WinApplication BuildApplication(string connectionString) {
        ...
        builder.UseApplication<finalllWindowsFormsApplication>();
        builder.Modules
            .AddCharts()
            .AddCloningXpo()
            ...
            .Add<finalll.Module.finalllModule>()
        	.Add<finalllWinModule>();
        ...
        builder.Security
            .UseIntegratedMode(options => {
                ...
                options.UserType = typeof(finalll.Module.BusinessObjects.ApplicationUser);
                options.UserLoginInfoType = typeof(finalll.Module.BusinessObjects.ApplicationUserLoginInfo);
